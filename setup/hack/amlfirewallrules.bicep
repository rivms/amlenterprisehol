...
resource hubvnetIpGroup 'Microsoft.Network/ipGroups@2022-01-01' existing = {
  name: 'hubvnetIpGroup'
}

resource amlspokeIpGroup 'Microsoft.Network/ipGroups@2022-01-01' existing = {
  name: 'amlspokeIpGroup'

}

resource mlsubnetAmlspokeIpGroup 'Microsoft.Network/ipGroups@2022-01-01' existing = {
